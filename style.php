<style>
    ...
    if (isset($_SESSION['theme']) && $_SESSION['theme'] === 'Dark') {
        ...
        echo "nav a::after { content: ''; position: absolute; width: 100%; height: 2px; background: #f4ff00; left: 0; bottom: -5px; transform: scaleX(0); transition: transform 0.5s ease; }";
        ...
        echo "#texT { color: red; text-shadow: 0 0 5px red; background-color: black; }";
        echo "#cool { color: red; text-shadow: 0 0 5px red; }";
